...
export const projectsData = [
  {
    id: 1,
    name: "Anonymous Feedback / Message Web App",
    description: "Send and receive anonymously",
    date: "2024-08-29",
    demoLink: "",
    gitRepo:
      "https://github.com/swayamjain8/Anonymous-Feedback-Message-Web-App",
  },
  {
    id: 2,
...
export const BtnList = [
  ...
  {
    label: "Github",
    link: "https://www.github.com/swayamjain8",
    icon: "github",
    newTab: true,
  },
  {
    label: "LinkedIn",
    link: "https://www.linkedin.com/in/swayamjain8",
    icon: "linkedin",
    newTab: true,
  },
  {
    label: "X",
    link: "https://www.x.com/swayam_jain_8x",
    icon: "twitter",
    newTab: true,
  },
  {
    label: "Resume",
    link: "/Swayam Jain Resume.pdf",
    icon: "resume",
    newTab: true,
  },
];
